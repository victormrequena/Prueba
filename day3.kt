package com.victormrequena.day3
...
fun main() {
    val input = """...........441.................367................296........................................567..47.....45.................947.............
...
....................571.......................720..........269...........885.............................902...........80...738..........975"""
    ...
    val numbers = input.lines()
        .flatMapIndexed { lineNumber, line ->
            numberRegex.findAll(line)
                .map { match ->
                    lineNumber to match.range to match.value
                }
        }.toMap()
    val mark2 = timeSource.markNow()

    val mark3 = timeSource.markNow()
    val symbols = input.lines()
        .flatMapIndexed { lineNumber, line ->
            symbolRegex.findAll(line)
                .map { match ->
                    lineNumber to match.range.first to match.value
                }
        }.toMap()
    ...
    val selected = numbers
        .filter { number ->
            symbols.any {
                it.key.first >= number.key.first - 1
                        && it.key.first <= number.key.first + 1
                        && it.key.second >= number.key.second.first - 1
                        && it.key.second <= number.key.second.last + 1
            }
        }.map { it.value.toInt() }
        .sum()
    ...
    val symbolPartitions = symbols.asSequence()
        .partition { symbol ->
            symbol.value == "*"
                    && numbers.filter {
                it.key.first >= symbol.key.first - 1
                        && it.key.first <= symbol.key.first + 1
                        && it.key.second.last >= symbol.key.second - 1
                        && it.key.second.first <= symbol.key.second + 1
            }.size == 2
        }
    val gears = symbolPartitions.first
    val notGears = symbolPartitions.second

    val multiplications = gears.sumOf { gear ->
        numbers.filter { number ->
            number.key.first >= gear.key.first - 1
                    && number.key.first <= gear.key.first + 1
                    && number.key.second.last >= gear.key.second - 1
                    && number.key.second.first <= gear.key.second + 1
        }.map { it.value.toInt() }.reduce { a, b -> a * b }
    }
